          ...
          <form action="" method="POST" class="form-horizontal" enctype="multipart/form-data" >
            <div class="control-group">
              ...
              <div class="controls">
                ...
                <input type="text" class="span11" placeholder="Productname" name="productname" value="<?php echo $product['productname'];?>" />
              </div>
            </div>
            <div class="control-group">
              ...
              <div class="controls">
                <select name="categoryid" id="inputCategoryid" class="form-control" required="required">
                  ...
                  <option value="<?php echo $value['categoryid']; ?>" <?php if($value['categoryid']==$product['categoryid']) echo "selected";?>><?php echo $value['categoryname']; ?></option>
                <?php endforeach; ?>
                </select>
              </div>
            </div>
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" class="span11" placeholder="Price" name="price" value="<?php echo $product['price'];?>" />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">Description</label>
              <div class="controls">
                <textarea name="description" class="span11" ><?php echo $product['description'];?></textarea>
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">Image :</label>
              <div class="controls">
                <input type="file" name="file_image" class="span11" placeholder="Image" value="<?php echo $product['image']; ?>" />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">By User :</label>
              <div class="controls">
                <input name="by_user" type="text" class="span11" placeholder="Company name" value="<?php echo $product['by_user'];?>" />
              </div>
            </div>
            <div class="form-actions">
              <button name="action" value="update_product" type="submit" class="btn btn-success">Update</button>
            </div>
          </form>
        </div>
        </div>
