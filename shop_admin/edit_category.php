        ...
        <div class="widget-box">
          ...
          <form action="" method="POST" class="form-horizontal">
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" class="span11" placeholder="Category name" name="categoryname" value="<?php echo $category['categoryname'];?>" />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">Description</label>
              <div class="controls">
                <textarea name="description" class="span11" ><?php echo $category['description'];?></textarea>
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">By User :</label>
              <div class="controls">
                <input name="by_user" type="text" class="span11" placeholder="Company name" value="<?php echo $category['by_user'];?>" />
              </div>
            </div>
            <div class="form-actions">
              <button name="action" value="update_category" type="submit" class="btn btn-success">Update</button>
            </div>
          </form>
        </div>
        </div>
